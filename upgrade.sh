...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES=(
    "https://github.com/Vioneta/VionetaOS/releases/download/${CASA_TAG}/linux-${TARGET_ARCH}-vionetaos-${CASA_TAG}.tar.gz"
	"https://github.com/Vioneta/VionetaOS-Gateway/releases/download/${CASA_TAG}/linux-${TARGET_ARCH}-vionetaos-gateway-${CASA_TAG}.tar.gz"
        "https://github.com/Vioneta/VionetaOS-UserService/releases/download/${CASA_TAG}/linux-${TARGET_ARCH}-vionetaos-user-service-${CASA_TAG}.tar.gz"
	"https://github.com/Vioneta/VionetaOS-UI/releases/download/${CASA_TAG}/linux-all-vionetaos-${CASA_TAG}.tar.gz"
)
}
