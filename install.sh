...
readonly CASA_CONF_PATH=/etc/vionetaos/gateway.ini
readonly CASA_UNINSTALL_URL="https://raw.githubusercontent.com/Vioneta/get/main/vionetaos-uninstall"
...
Check_Docker_Install_Final() {
    if [[ -x "$(command -v docker)" ]]; then
        ...
        Show 1 "Installation failed, please run 'curl -fsSL https://get.docker.com | bash' and rerun the VionetaOS installation script."
        exit 1
    fi
}
...
DownloadAndInstallVionetaOS() {
    if [ -z "${BUILD_DIR}" ]; then
        ...
        for PACKAGE_FILE in linux-*-vionetaos-*.tar.gz; do
    ...
    ${sudo_cmd} cp -rf "${SYSROOT_DIR}"/* / || Show 1 "Failed to install VionetaOS"
    ColorReset
    ...
    ${sudo_cmd} cp -rf "$PREFIX/tmp/vionetaos-uninstall" $CASA_UNINSTALL_PATH || {
...
# Show Welcome Banner
Welcome_Banner() {
    CASA_TAG=$(vionetaos -v)

    echo -e "${GREEN_LINE}${aCOLOUR[1]}"
    echo -e " VionetaOS ${CASA_TAG}${COLOUR_RESET} is running at${COLOUR_RESET}${GREEN_SEPARATOR}"
    echo -e "${GREEN_LINE}"
    Get_IPs
    echo -e " Open your browser and visit the above address."
    echo -e "${GREEN_LINE}"
    echo -e ""
    echo -e " ${aCOLOUR[2]}VionetaOS Project  : https://github.com/Vioneta/VionetaOS"
    echo -e " ${aCOLOUR[2]}VionetaOS Team     : https://github.com/Vioneta/VionetaOS#maintainers"
    echo -e " ${aCOLOUR[2]}VionetaOS Discord  : https://discord.gg/knqAbbBbeX"
    echo -e " ${aCOLOUR[2]}Website         : https://www.vionetaos.com"
    echo -e " ${aCOLOUR[2]}Online Demo     : http://demo.vionetaos.com"
    echo -e ""
    echo -e " ${COLOUR_RESET}${aCOLOUR[1]}Uninstall       ${COLOUR_RESET}: vionetaos-uninstall"
    echo -e "${COLOUR_RESET}"
}
...
# Step 8: Download And Install VionetaOS
DownloadAndInstallVionetaOS
