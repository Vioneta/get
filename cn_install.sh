...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES=(
        "https://vionetaos.oss-cn-shanghai.aliyuncs.com/v0.3.6/linux-${TARGET_ARCH}-vionetaos-gateway-v0.3.6.tar.gz"
        "https://vionetaos.oss-cn-shanghai.aliyuncs.com/v0.3.6/linux-${TARGET_ARCH}-vionetaos-user-service-v0.3.6.tar.gz"
        "https://vionetaos.oss-cn-shanghai.aliyuncs.com/v0.3.6/linux-${TARGET_ARCH}-vionetaos-v0.3.6.tar.gz"
        "https://vionetaos.oss-cn-shanghai.aliyuncs.com/v0.3.6/linux-all-vionetaos-v0.3.6.tar.gz"
    )
}
...
DownloadAndInstallVionetaOS() {
    # Get the latest version of VionetaOS
    if [[ ! -n "$version" ]]; then
...
Welcome_Banner() {
    ...
    echo -e " ${aCOLOUR[2]}Website         : https://www.vionetaos.io"
    echo -e " ${aCOLOUR[2]}Online Demo     : http://demo.vionetaos.io"
    echo -e ""
