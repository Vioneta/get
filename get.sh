...
#   Usage:
#
#   	$ curl -fsSL https://raw.githubusercontent.com/Vioneta/get/main/install.sh | sudo bash
#   	  or
#   	$ wget -qO- https://raw.githubusercontent.com/Vioneta/get/main/install.sh | sudo bash
#
...
readonly TITLE="VionetaOS Installer"
...
readonly CASA_UNINSTALL_URL="https://raw.githubusercontent.com/Vioneta/get/main/uninstall.sh"
...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES=(
        "https://github.com/Vioneta/VionetaOS-Gateway/releases/download/v0.1.0/linux-${TARGET_ARCH}-vionetaos-gateway-v0.1.0.tar.gz"
        "https://github.com/Vioneta/VionetaOS-UserService/releases/download/v0.1.0/linux-${TARGET_ARCH}-vionetaos-user-service-v0.1.0.tar.gz"
        "https://github.com/Vioneta/VionetaOS-LocalStorage/releases/download/v0.1.0/linux-${TARGET_ARCH}-vionetaos-local-storage-v0.1.0.tar.gz"
        "https://github.com/Vioneta/VionetaOS/releases/download/v0.1.0/linux-${TARGET_ARCH}-vionetaos-v0.1.0.tar.gz"
        "https://github.com/Vioneta/VionetaOS-UI/releases/download/v0.1.0/linux-all-vionetaos-v0.1.0.tar.gz"
    )
}
